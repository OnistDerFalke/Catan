...
namespace Board
{
    public class ElementDistributor
    {
         ...
         private void SetupBasicDistribution()
         {
            ...
            {
               GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Red)].properties
                    .AddBuilding(8, false, true);
               GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Red)].properties
                    .AddBuilding(28, false, true);
               GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Red)].properties
                    .AddPath(13, true);
               GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Red)].properties
                    .AddPath(41, true);
            ...
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Yellow)].properties
                .AddBuilding(14, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Yellow)].properties
                .AddBuilding(40, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Yellow)].properties
                .AddPath(15, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Yellow)].properties
                .AddPath(58, true);
            ...
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.White)].properties
                .AddBuilding(17, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.White)].properties
                .AddBuilding(31, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.White)].properties
                .AddPath(25, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.White)].properties
                .AddPath(37, true);
            ...
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Blue)].properties
                .AddBuilding(39, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Blue)].properties
                .AddBuilding(41, false, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Blue)].properties
                .AddPath(56, true);
            GameManager.Players[GameManager.GetPlayerIdByColor(Player.Player.Color.Blue)].properties
                .AddPath(52, true);
